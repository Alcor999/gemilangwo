...
<div class="container-fluid">
    <div class="row mb-4">
        <div class="col-md-8">
            <h1 class="mb-1" style="font-family: \'Playfair Display\', serif; font-size: 2rem; font-weight: 600; color: var(--text-dark);"><i class="fas fa-edit"></i> Ubah Diskon</h1>
        </div>
        ...
        <div class="col-lg-4">
            <div class="card">
                <div class="card-header bg-transparent border-0 pt-4 pb-0 px-4">
                    <h5 class="mb-0 fw-bold" style="font-family: \'Playfair Display\', serif;"><i class="fas fa-info-circle"></i> Info Diskon</h5>
                </div>
                <div class="card-body">
                    <p class="small">
