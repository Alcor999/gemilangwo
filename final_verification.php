...
test('Packages table exists', function () {
    return \Schema::hasTable('packages');
});
test('Orders table exists', function () {
...
test('Wishlists table exists', function () {
    return \Schema::hasTable('wishlists');
});
test('Gallery images table exists', function () {
    return \Schema::hasTable('gallery_images');
});
test('Video testimonials table exists', function () {
    return \Schema::hasTable('video_testimonials');
});
test('Support tickets table exists', function () {
    return \Schema::hasTable('support_tickets');
});
test('Chat messages table exists', function () {
    return \Schema::hasTable('chat_messages');
});
test('Calendar events table exists', function () {
    return \Schema::hasTable('calendar_events');
});
test('Blocked dates table exists', function () {
    return \Schema::hasTable('blocked_dates');
});
test('Availability table exists', function () {
    return \Schema::hasTable('availability');
});
test('SMS logs table exists', function () {
...
test('Customer user exists', function () {
    return \App\Models\User::where('role', 'customer')->count() > 0;
});
test('Owner user exists', function () {
    return \App\Models\User::where('role', 'owner')->count() > 0;
});
test('Total users count >= 3', function () {
    return \App\Models\User::count() >= 3;
});
...
test('Packages exist in database', function () {
...
test('Orders exist in database', function () {
...
test('Reviews table has data', function () {
...
test('Discounts exist in database', function () {
    return \App\Models\Discount::count() > 0;
});
...
test('Package has orders relationship', function () {
    return method_exists(\App\Models\Package::first(), 'orders');
});
test('Package has reviews relationship', function () {
    return method_exists(\App\Models\Package::first(), 'reviews');
});
test('Package has discounts relationship', function () {
    return method_exists(\App\Models\Package::first(), 'discounts');
});
test('User has orders relationship', function () {
    return method_exists(\App\Models\User::first(), 'orders');
});
test('User has reviews relationship', function () {
    return method_exists(\App\Models\User::first(), 'reviews');
});
test('Order has user relationship', function () {
    return method_exists(\App\Models\Order::first(), 'user');
});
test('Order has package relationship', function () {
    return method_exists(\App\Models\Order::first(), 'package');
});
